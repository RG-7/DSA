/*
    ...
    LRU Cache with Implementations
*/
...
// A utility function to create an empty Queue. The queue can have at most 'numberOfFrames' nodes
...
/* This function is called when a page with given 'pageNumber' is referenced from cache (or memory). There are two cases:
